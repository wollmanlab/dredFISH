"""Code from: https://raw.githubusercontent.com/jacobgil/Ambrosio-Tortorelli-Minimizer/master/AmbrosioTortorelliMinimizer.py
Mumford Shah image segmentation problem
