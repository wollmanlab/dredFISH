...
for level in levels:
    ...
    logging.info(ctrds_.shape)
    logging.info(types_.shape)
...
for i in range(len(levels)):
    ...
    logging.info(i, ctrds_diff.shape)
...
output = os.path.join(res_dir, "smrt_X_DPNMF_testrun_tree_v1-p2.h5ad")
...
output = os.path.join(res_dir, "smrt_X_DPNMF_tree_v1-p2.h5ad")
