...
# metadata -- to get the tree
meta_path = '/bigstore/GeneralStorage/fangming/projects/dredfish/data/rna/scrna_ss_ctxhippo_a_exon_DPNMF_genes_matrix.h5ad'
...
# outputs
output1 = os.path.join(res_dir, "smrt_X_DPNMF_testrun_tree_newgenes_v4.h5ad")
output2 = os.path.join(res_dir, "smrt_X_DPNMF_tree_newgenes_v4.h5ad")
...
meta = anndata.read_h5ad(meta_path, backed='r').obs.copy()
meta = meta.loc[cells]
