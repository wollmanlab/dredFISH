...
import torch
import os
from dredFISH.Design.model_v2p2_gene_constraints import train_model
...
lmd0 = 1 
lmd2 = 1
n_bits = [12, 18, 24] # [6,12,24]
n_rcn = 0 # 1, 2, 3, 0 
lr = 1e-2
# scale = 1e5
scales = [10, 100, 1e3, 1e4, 1e5, 1e6, 1e7]
noise = None #(1e1, 1)
# scale = 1.5e5
# noise = (1e5, 1e4)

studybatch = f"types_v23_Sep2"
