...
drprt = 0 #.01 #0.05
studybatch = f"types_v26_Sep13_drprt{drprt:.1e}"
...
for libsize_norm in [True, False]:
    res_path = f'/bigstore/GeneralStorage/fangming/projects/dredfish/res_nn/{studybatch}_libsize{libsize_norm}_scale{scale:.1e}_lmd0{lmd0:.2e}_lmd2{lmd2:.2e}_nbit{n_bit}_nrcn{n_rcn}_lr{lr:.1g}'
    print(res_path)
