...
for n_bit in n_bits:
    n_bit = n_bit
    res_path = f'/bigstore/GeneralStorage/fangming/projects/dredfish/res_nn/11-smrt-zdim_lmd0{lmd0:.2e}_nbit{n_bit}_nrcn{n_rcn}_lr{lr:.1g}'
    print(res_path)
