...
res_path= f'/bigstore/GeneralStorage/fangming/projects/dredfish/res_nn/10-v1-smrt-gene140_lmd0{lmd0:.2e}_nbit{n_bit}_nrcn{n_rcn}_lr{lr:.1g}'
print(res_path)
...
# trn_dataloader = data_loader_scrna.load_Allen_data(
#     dataset_key='tenx_trn', 
#     keyX='counts', keyY='l3_code', keyYcat='l3_cat', 
#     batch_size=64,
# )
# tst_dataloader = data_loader_scrna.load_Allen_data(
#     dataset_key='tenx_tst', 
#     keyX='counts', keyY='l3_code', keyYcat='l3_cat', 
#     batch_size=500,
# )
...
train_model(trn_dataloader, tst_dataloader, gsubidx, res_path, lmd0, 
            n_bit=n_bit, n_rcn_layers=n_rcn, n_epochs=n_epochs, n_iter=n_iter, lr=lr, path_trained_model='')
