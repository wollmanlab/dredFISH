...
class DataIter():
    ...
    def __init__(self, labels= ( 'Level_2_neighborhood_label',
                 ...
                 path_dict= dict(root_path= '/bigstore/binfo/mouse/Brain/DRedFISH/Allen_V3_Reference',
                                 ...
                                 tenx_cells_path= './10X_dpnmf/cells.npy',
                                 tenx_genes_path= './10X_dpnmf/genes.npy',
                                 tenx_metadata_path= './10X_dpnmf/metadata.csv',
                                 tenx_counts_path= './10X_dpnmf/matrix.npy',
                                 #smrt_lengths_path= './SmartSeq/gene_length.npy',
                                 smrt_genes_path='./SmartSeq_dpnmf/genes.npy',
                                 smrt_cells_path= './SmartSeq_dpnmf/cells.npy',
                                 smrt_metadata_path= './SmartSeq_dpnmf/metadata.csv',
                                 smrt_counts_path= './SmartSeq_dpnmf/matrix.npy'),
                 n_iter= int(3e3),
                 cell_train_itr= 50):
        self.iter= 0
        self.n_iter= n_iter
    ...
    def cache_train_dat(self, output_path='/bigstore/binfo/mouse/Brain/DRedFISH/Allen_V3_Reference/cache/_3', drprt=0.):
        '''
        Write files to ouput directories for training and validation at the level of fine-grained
...
class DataIterCached():
    ...
    ----------
        ...
        n_iter: number of iterations
    """
    def __init__(self, cached_path= '/bigstore/binfo/mouse/Brain/DRedFISH/Allen_V3_Reference/cache/_3',
                 n_iter= int(3e3)):
        self.iter= 0
        self.n_iter= n_iter
