...
from dredFISH.Design.allen_data_files import *
...
def load_Allen_data(datasetkey='', path_zarr='', keyX='counts', keyY='l3_code', keyYcat='l3_cat', batch_size=64, tinydata=0):
    """
    """
    if len(path_zarr):
        pass
    elif len(datasetkey):
        path_zarr = ALLEN_DATADICT[datasetkey]
    else:
