...
from allen_data_iterators_subgenes import DataIterCached
...
def train_model(res_path, lmd0, lmd1, min_pos, n_bit=24, n_iter=2000):
    """
...
if __name__=='__main__':
    ...
    train_model(res_path, lmd0, lmd1, min_pos, n_bit=24, n_iter=n_iter)
