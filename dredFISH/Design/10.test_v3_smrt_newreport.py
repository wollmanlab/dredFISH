...
import torch
import os
from dredFISH.Design.model_v1p2_gene_celltype_reportupgrade import train_model
...
res_path =      f'/bigstore/GeneralStorage/fangming/projects/dredfish/res_nn/10-v10-smrt-newreport-gene140_lmd0{lmd0:.2e}_nbit{n_bit}_nrcn{n_rcn}_lr{lr:.1g}'
